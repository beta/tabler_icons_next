...
class DeviceVisionProWifi extends Icon {
  const DeviceVisionProWifi({
    super.key,
    super.strokeWidth,
    super.width,
    super.height,
...
tags: [advanced, sight, future, virtual, augmented, headset, vr, ar, wifi, wireless, connection, network, signal]
category: Devices
unicode: "10274"
version: "3.45"
-->
